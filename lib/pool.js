...
function handleMinerMethod(method, params, ip, portData, sendReply, pushMessage){
    ...
    switch(method){
        case 'login':
            ...
            if (paymentId && paymentId.match('[^a-zA-Z0-9]{16,}/i')) {
                ...
                sendReply(`Invalid paymentId specified for login, ${miner.ip} banned for ${config.poolServer.banning.time / 60} minutes`);
                return
            }            
